...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT( \
      ...
      KC_HENK,       KC_P,          KC_K,          KC_R,      KC_A,      KC_F,                                   _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_OPT] = LAYOUT( \
      ...
      KC_MHEN, KC_J,   KC_M,    KC_B,   KC_QUOT,   KC_TAB,                    _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_OPT_106] = LAYOUT( \
      ...
      KC_MHEN, KC_J,   KC_M,    KC_B,   JP_QUOT,   KC_TAB,                    _______,  _______,  _______,  _______,  _______,  _______, \
      KC_DOT,  KC_V,   KC_C,    KC_L,   KC_Z,      KC_Q,                      _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_NUM_106] = LAYOUT( \
      _______,  _______, OSL(_FUNC), KC_HOME, KC_END,  _______,                          _______,  _______,  _______,  _______,  _______,  _______, \
      _______,  JP_ASTR, KC_7,       KC_8,    KC_9,    JP_MINS,                          _______,  _______,  _______,  _______,  _______,  _______, \
      KC_DOT,   JP_SLSH, KC_4,       KC_5,    KC_6,    JP_PLUS,                          _______,  _______,  _______,  _______,  _______,  _______, \
      KC_NLCK,  KC_0,    KC_1,       KC_2,    KC_3,    LCTL(S(KC_F1)), _______, _______, _______,  _______,  _______,  _______,  _______,  _______, \
